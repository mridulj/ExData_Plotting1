...
par(mfrow=c(2,2))
plot(x,dat$Global_active_power,type='l',xlab='',ylab='Global Active Power')
plot(x,dat$Voltage,type='l',xlab='datetime',ylab='Voltage')
...
plot(x,dat$Global_reactive_power,type='l',xlab='datetime',ylab='Global_reactive_power')
dev.off();